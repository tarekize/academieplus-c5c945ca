...
export const mathTerminaleGestionChapters: Chapter[] = [
  {
    ...
    lessons: [
      ...
      { id: "lesson-1-6", title: "Suite dÃ©finie par Un+1 = aUn + b", titleAr: "Ø§Ù„ØªØ¹Ø±Ù Ø¹Ù„Ù‰ Ù…ØªØªØ§Ù„ÙŠØ© Ù…Ø¹Ø±ÙØ© Ø¨Ø§Ù„Ø¹Ù„Ø§Ù‚Ø© : Un+1= aUn+bÙˆ Ø­Ø³Ø§Ø¨ Ø­Ø¯ÙˆØ¯Ù‡Ø§" },
      { id: "lesson-1-7", title: "Convergence d'une suite rÃ©currente un+1=f(un)", titleAr: "ØªÙ‚Ø§Ø±Ø¨ Ù…ØªØªØ§Ù„ÙŠØ© ØªØ±Ø§Ø¬Ø¹ÙŠØ© ð®ð§+ðŸ=f(un) Ø¨Ø§Ù„Ø§Ø³ØªØ¹Ø§Ù†Ø© Ø¨Ø§Ù„Ø¯Ø§Ù„Ø©" },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "lesson-5-4", "title": "Application de l'intÃ©grale au calcul d'aires", "titleAr": "ØªÙˆØ¸ÙŠÙ Ø§Ù„ØªÙƒØ§Ù…Ù„ ÙÙ‰ Ø­Ø³Ø§Ø¨ Ø§Ù„Ù…Ø³Ø§Ø­Ø§Øª" },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      { id: "lesson-8-1", title: "Loi de probabilitÃ©", titleAr: "Ù‚Ø§Ù†ÙˆÙ† Ø§Ø­ØªÙ…Ø§Ù„ Ù…Ø±ÙÙ‚ Ø¨ØªØ¬Ø±Ø¨Ø© Ø¹Ø´ÙˆØ§Ø¦ÙŠØ©" },
