...
const ITEMS: NavItem[] = [
  ...
  { key: "lessons", icon: BookOpen, label: "الدروس", path: "/liste-matieres", match: (p) => p.startsWith("/liste-matieres") || p.startsWith("/cours") },
  { key: "practice", icon: PenTool, label: "تمارين", path: "/cours/math/chapitres", match: () => false },
