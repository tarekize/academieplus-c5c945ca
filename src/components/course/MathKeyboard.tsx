...
const SYMBOL_GROUPS: { label: string; symbols: { display: string; insert: string; title?: string }[] }[] = [
  ...
  },
  {
    ...
    symbols: [
      ...
      { display: "→", insert: "→" },
      { display: "∫", insert: "∫" },
      { display: "∫ₐᵇ", insert: "∫_a^b ", title: "Intégrale entre bornes a et b" },
      { display: "∬", insert: "∬", title: "Intégrale double" },
      { display: "∭", insert: "∭", title: "Intégrale triple" },
      { display: "∑", insert: "∑" },
      { display: "∑ᵢ₌₁ⁿ", insert: "∑_i=1^n ", title: "Somme de i=1 à n" },
      { display: "∏", insert: "∏" },
      { display: "∂", insert: "∂" },
