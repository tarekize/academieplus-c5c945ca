...
export function AddUserDialog({ onUserAdded }: AddUserDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (role === "student" && !schoolLevel) {
      toast.error("Veuillez s̩lectionner un niveau scolaire pour l'̩l̬ve.");
      return;
    }
    ...
    try {
      ...
      if (response.error) {
        throw new Error(response.error.message || "Erreur lors de la cr̩ation");
      }
    ...
    >
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Cr̩ez un nouveau compte utilisateur (admin, parent ou ̩l̬ve).
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={setRole}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="pedago">P̩dago</SelectItem>
