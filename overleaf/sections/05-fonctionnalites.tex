...
404 & \texttt{*} & Page \og non trouvée\fg{}. \\
\bottomrule
\end{longtable}
...
\begin{itemize}
  ...
  \item \filepath{LessonActivityTabs} --- organise les activités en trois étapes
        pédagogiques~: \emph{Découvrir}, \emph{Comprendre} et \emph{Approfondir}
        (contenu IA). L'accès à l'approfondissement est conditionné
