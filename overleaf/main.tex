...
\input{sections/03-stack-technique}
\input{sections/04-roles-auth}
\input{sections/05-fonctionnalites}
\input{sections/06-moteur-adaptatif}
\input{sections/07-base-de-donnees}
\input{sections/08-mcd}
\input{sections/09-edge-functions}
\input{sections/10-securite-rls}
\input{sections/11-deploiement}
