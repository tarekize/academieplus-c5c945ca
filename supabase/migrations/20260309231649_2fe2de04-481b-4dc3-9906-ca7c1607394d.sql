...
-- Add wilaya, ville, ecole columns to profiles table
...
-- Update handle_new_user trigger to include these fields
...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, email_verified, first_name, last_name, school_level, filiere, date_of_birth, wilaya, ville, ecole)
  VALUES (
