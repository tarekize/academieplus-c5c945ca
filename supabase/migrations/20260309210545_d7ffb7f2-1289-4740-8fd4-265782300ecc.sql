...
-- Update handle_new_user trigger to save date_of_birth
...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, email_verified, first_name, last_name, school_level, filiere, date_of_birth)
  VALUES (
